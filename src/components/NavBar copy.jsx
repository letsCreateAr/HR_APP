    ...
    return (
        <Toolbar>
            <nav class="flex justify-between py-3 bg-white backdrop-blur-none shadow-sm w-full fixed top-0 left-0 right-0 z-10">
                ...
                <div class="items-center flex md:flex md:flex-grow flex-row justify-end space-x-1">
                ...
                <div class="items-center flex md:flex md:flex-grow flex-row justify-end space-x-1 pr-5">
                    <IconButton 
                        aria-haspopup="true"
                        onClick={handleMenu}
                        style={{color: 'black'}}>
