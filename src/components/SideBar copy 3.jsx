...
function SideBar(){
    ...
    const Menus = [
        ...
        { title: "My Tasks", path: "/tasks", src: "Chat" },
        { title: "Lunchtime", path: "/lunchtime", src: "User", gap: true },
        { title: "Contact List", path: "/contactlist", src: "Calendar" },
        { title: "My Info", path: "/myinfo", src: "Folder", gap: true },
        { title: "Settings", path: "/settings", src: "Setting" },
    ];
                ...
                <ul className="pt-6">
                    {Menus.map((Menu, index) => (
                        ...
                        >
                            ...
                            <span className={`${!open && "hidden"} ml-4 whitespace-nowrap origin-left duration-200`}>
                                {Menu.title}
                            </span>
                            </div>
                            </Link>
